   ...
   */
   public int findMinimum( int column )
   {
    ...
    // Write your code here:
	    ...
	    {
	        int currentValue = intArray[i][column];
   ...
   */
   public int countFound( int value )
   {
    ...
    // Write your code here:
	    ...
	    int num = 0; // Initialize the frequency count to 0
	    ...
	    for (int i = 0; i < intArray.length; i++)
	    {
	        for (int j = 0; j < intArray[i].length; j++)
	        {
	            ...
	            {
	                num++; // Increment the frequency count when the value is found
	            }
	            animate(i, j, num); // Needed to create visual feedback
	        }
	    }
